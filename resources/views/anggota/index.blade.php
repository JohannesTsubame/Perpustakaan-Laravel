...
@section('contents')
    ...
    <div class = "Header">
        ...
        <div style="display: flex">
            <form action="{{ route('anggota.print_data') }}" class="mt-2" target="_blank">
                <button type="submit" class="btn btn-danger ml-2">
                    <i class="fa fa-print"></i> Print Data
                </button>
            </form> 

            <form action="{{ route('anggota.export') }}" class="mt-2" target="_blank">
                ...
                <tr>
                    ...
                    <td>
                        <div class="action">
                            ...
                            <form id="Form{{ $a->kode_anggota }}" action="{{ route('anggota.delete', $a->id) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-danger mr-2 ml-2"
